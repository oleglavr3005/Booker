            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left prev">
                        ...
                        <span class="hotel_button_previous"><span>
                    </button>
			...
			<c:if test="${fn:length(hotel.photos) == 0}">
					...
					<c:if test="${fn:length(hotel.photos) != 0}">
						<a href='<i:urlToImage url="${hotel.photos[0].img}" />'
							data-gallery>
							<img src="<i:urlToImage url="${hotel.photos[0].img }" />"  style="height: 170px; width: 200px; padding: 10px;">
						</a>
...
<!-- 						</a> -->
					...
					<div class="col s6">
						...
						<div class="row" style="margin-bottom: 10px">
							<a class="tooltipped placeholder_phone_number" data-position="icon"
								data-tooltip=""
								style="color: #0d0d0d; text-decoration: none;"><i
					...
					<div class="col s2">
						<div class="row" style="margin-top: 14px; margin-bottom:5px;">
							<a class="tooltipped tooltip_rating" data-position="icon" data-tooltip=""
