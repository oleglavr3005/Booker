...
//		var height = $('#details_panel').height();
//		document.getElementById("#details_panel").animate({
//			height : "0px",
//			opacity : 0
//		}, 0, function() {
//			document.getElementById("#details_panel").animate({
...
//			}, 500, function() {
		//		$("#subscribing_form").html(content);
				...
				document.getElementById('details_panel').style.display = "block";	//needed procedure!
