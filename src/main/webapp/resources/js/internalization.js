...
(function (){
	var en = {
		...
		shoping_card_date_asc : "date <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		shoping_card_date_desc : "date <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		shoping_card_price_asc : "price <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		shoping_card_price_desc : "price <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		...
		index_option_star_asc : "star <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		index_option_star_desc : "star <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		index_option_rating_asc : "rating <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		index_option_rating_desc : "rating <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",	
		index_option_people_desc : "people <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		
		hotel_option_star_asc : "star <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		hotel_option_star_desc : "star <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		hotel_option_people_asc : "people <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
	...
	var ua = {
		...
		shoping_card_date_asc : "даті <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		shoping_card_date_desc : "даті <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		shoping_card_price_asc : "ціні <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		shoping_card_price_desc : "ціні <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		...
		hotel_option_star_asc : "зіркам <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		hotel_option_star_desc : "зіркам <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		hotel_option_people_asc : "міскості <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		hotel_option_people_desc : "міскості <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		
		map_button : "Карта", 
		search : "Пошук",
		
		index_option_star_asc : "зіркам <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		index_option_star_desc : "зіркам <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",
		index_option_rating_asc : "рейтингу <i class='tiny material-icons' style='transform: rotate(90deg);'>trending_flat</i>",
		index_option_rating_desc : "рейтингу <i class='tiny material-icons' style='transform: rotate(-90deg);'>trending_flat</i>",	
