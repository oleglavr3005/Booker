...
public class FindHotelsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String name = "Hotel1"; //get from request
		int minStars = 3; //get from request
		int maxStars = 5; //get from request
		int people = 5; //get from request
		
		boolean typeStandart = true; //get from request
		boolean typeLux = true; //get from request
		boolean typeDelux = true; //get from request

		boolean foodNone = true; //get from request
		boolean foodBreakfast = true; //get from request
		boolean foodTwice = true; //get from request
		boolean foodFull = true; //get from request
		
		int minPrice = 1; //get from request
		int maxPrice = 500; //get from request

		boolean hasWiFi = true; //get from request
		boolean hasShower = true; //get from request
		boolean hasParking = true; //get from request
		boolean hasCondition = true; //get from request
		boolean hasPool = true; //get from request
		boolean hasGym = true; //get from request
		boolean hasBalcony = true; //get from request
